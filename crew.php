...
if ($username == '') 
{
	...
	if(isset($_POST['edit']))
	{
		...
		$cid=$_POST["cid"];
		$_SESSION["cid"] = "$cid";
		header('Location:http://web.njit.edu/~aps64/it490/edit_crew.php');
		...
		if(isset($_POST['delete']))
	{
		...
		$cid=$_POST["cid"];
		$_SESSION["cid"] = "$cid";
		header('Location:http://web.njit.edu/~aps64/it490/dlt_crew.php');
	}
   ...
   <div class="container" style="width:70%; margin-left:auto;margin-right:auto;">
        <div class="jumbotron">  
                <div class="row">
					...
					<br>
					<div class="subtitle" align="center"><u>AirCrew</u></div><br>
			...
			<form action="crew.php" method="post">
				...
				<?php
					...
					{		
						...
						echo "<tr>";
						$q = "Select * from `Flight` where `Air Crew` = '$cid'";
						$x = mysql_query ($q);
						$cnt = mysql_num_rows ($x);
	
						if ($cnt > 0 )
							echo "<td><input type='radio' name='cid' value=$cid 
										title='Allocated to Flight. Can not Edit/Delete' disabled></td>";
						else
							
						echo "<td><input type='radio' name='cid' value=$cid required></td>";
						echo "<td> $cid </td>";
						echo "<td> $pilot</td>";
						echo "<td> $navi</td>";
						echo "</tr>";
...
?>
  ...
  <!-- <script src="http://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script>
	...
	function popup()
	{
		window.open ("http://web.njit.edu/~aps64/it490/add_crew.php",
