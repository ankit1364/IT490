   ...
   <div class="container" style="margin-left:auto;margin-right:auto;">
        ...
        <div class ="jumbotron">
			<div class="row">
				...
				$sql="SELECT * from Flight where '$cid'= `Cargo ID`";
				($t=mysql_query($sql)) or  print mysql_error() ;
			
			if (mysql_num_rows($t)<1)
			{
				echo "<h4 align='center' style='color:red;'>Sorry, No Info found for your Cargo:</h4>
						<h3 align='center' style='color:blue;'>".$cid."</h3>";
				?>
				<br><h4 align="center"><a class="btn btn-primary" href="http://web.njit.edu/~aps64/it490/index.php" value="Back"> Back</a> </h4> 
				<?php
				exit();
			}
			else
				echo "<h3 align='center' style='color:green;'>Information for your Cargo:".$cid."</h3><br>";
			{
				?>
